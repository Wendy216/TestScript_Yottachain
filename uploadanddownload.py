...
if __name__ == "__main__":
    ...
    for config in list_config:
        if "config_fixed" in config["configfilename"]:
            ...
            logger.info(
                "Begin to run test file number=%d size=%d upload and download." % (int(file_number), int(file_size)))
            fp.append_report(report_file, "\n\n[%s] - begin to run test file number=%d file size=%d upload and download.\n"
